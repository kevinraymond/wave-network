...
def main():
    ...
    # Base configuration
    base_config = {
        "project_name": "wave-network-vs-bert-imdb",
        "weight_decay": 0.01,
        "num_epochs": 4,
        "warmup_steps": 100,
        "max_grad_norm": 1.0,
    ...
    data_wave = prepare_text_classification_data(
        train_path="hf/imdb/plain_text/train-00000-of-00001.parquet",
        test_path="hf/imdb/plain_text/test-00000-of-00001.parquet",
